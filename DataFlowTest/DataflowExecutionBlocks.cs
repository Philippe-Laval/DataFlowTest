...
public class DataflowExecutionBlocksAsync2
{
    public static void Run()
    {
        ...
        var countBytes = new TransformBlock<string, int>(async path =>
        {
            byte[] buffer = new byte[1024];
        ...
        countBytes.Completion.ContinueWith(delegate {
...
public class DataflowExecutionBlocksAsync1
{
    /// <summary>
    /// Asynchronously computes the number of zero bytes that the provided file contains.
    /// </summary>
    ...
    public static void Run()
    {
        ...
        var countBytes = new TransformBlock<string, int>(
           new Func<string, Task<int>>(CountBytesAsync)
           );
...
{
    /// <summary>
    /// Computes the number of zero bytes that the provided file contains
    /// </summary>
    /// <param name="path"></param>
    /// <returns></returns>
