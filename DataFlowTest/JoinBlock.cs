...
// https://learn.microsoft.com/en-us/dotnet/standard/parallel-programming/how-to-use-joinblock-to-read-data-from-multiple-sources
...
public static class JoinBlock
{
    ...
    public static async Task Run()
    {
        ...
        var disposable1 = joinNetworkAndMemoryResources.LinkTo(networkMemoryAction);
        var disposable2 = joinFileAndMemoryResources.LinkTo(fileMemoryAction);
        ...
        //networkResources.Complete();
        //memoryResources.Complete();
        //fileResources.Complete();

        //networkMemoryAction.Complete();
        //fileMemoryAction.Complete();

        //await networkMemoryAction.Completion;
        //await fileMemoryAction.Completion;
